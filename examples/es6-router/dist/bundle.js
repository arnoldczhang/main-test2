...
/******/ 			script.src = __webpack_require__.p + "" + chunkId + ".bundle.js?v=2017223614";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../examples/es6-router/node_modules/css-loader/index.js!./main.css", function() {
				var newContent = require("!!./../examples/es6-router/node_modules/css-loader/index.js!./main.css");
	  ...
	  **/
		var WARN = {
			...
			missComp: function missComp(tag) {
				return '`{1}` is not a component'.replace(/\{\d\}/g, tag);
			},
	 ...
	 **/
	  ...
	  */
		...
		function genComponent(vObj, attrStr, inst, parent, index) {
			...
			return LOG.warn(WARN.missComp(tagName)), '__j._n("' + vObj.tagName + '")';
		};
