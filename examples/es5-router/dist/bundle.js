...
/******/ 			script.src = __webpack_require__.p + "" + chunkId + ".bundle.js?v=2017216382";
	...
	JSpring.router('#container', {
	    ...
	    'mainPage' : {
	        ...
	        controllerFn :  function (resolve) {
	          __webpack_require__.e/* require */(1, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(5)(BASE + 'mainPage/mainPage.js')
	            , __webpack_require__(14)(BASE + 'mainPage/mainPage.css')]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	        },
	        title : '签证首页',
	        cach : true
	    },
	    ...
	    'visaList/:cityId' : {
	        ...
	        controllerFn : function (resolve) {
	          __webpack_require__.e/* require */(2, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(21)(BASE + 'visaList/visaList.js')
	            , __webpack_require__(23)(BASE + 'visaList/visaList.css')]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	        },
	        title : '签证列表',
	        cach : false
	    },
	    ...
	    'visaDetail/:goodsId' : {
	        ...
	        controllerFn : function (resolve) {
	          __webpack_require__.e/* require */(3, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(26)(BASE + 'visaDetail/visaDetail.js')
	            , __webpack_require__(28)(BASE + 'visaDetail/visaDetail.css')]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	        },
	        title : '签证详情',
	        cach : false
	    },
