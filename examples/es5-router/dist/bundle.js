...
/******/ 			script.src = __webpack_require__.p + "" + chunkId + ".bundle.js?v=2017217798";
...
/***/ function(module, exports, __webpack_require__) {
	...
	/**
	  * router config
	  **/
	var JSpring = __webpack_require__(2);
	...
	JSpring.router('#container', {
	    ...
	    'mainPage' : {
	        ...
	        controllerFn :  function (resolve) {
	          __webpack_require__.e/* require */(1, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(9)(BASE + 'mainPage/mainPage.js')
	            , __webpack_require__(18)(BASE + 'mainPage/mainPage.css')]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	        },
	        title : '签证首页',
	        cach : true
	    },
	    ...
	    'visaList/:cityId' : {
	        ...
	        controllerFn : function (resolve) {
	          __webpack_require__.e/* require */(2, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(23)(BASE + 'visaList/visaList.js')
	            , __webpack_require__(27)(BASE + 'visaList/visaList.css')]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	        },
	        title : '签证列表',
	        cach : false
	    },
	    ...
	    'visaDetail/:goodsId' : {
	        ...
	        controllerFn : function (resolve) {
	          __webpack_require__.e/* require */(3, function(__webpack_require__) { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(30)(BASE + 'visaDetail/visaDetail.js')
	            , __webpack_require__(34)(BASE + 'visaDetail/visaDetail.css')]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this));
	        },
	        title : '签证详情',
	        cach : false
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../examples/es5-router/node_modules/css-loader/index.js!./main.css", function() {
				var newContent = require("!!./../examples/es5-router/node_modules/css-loader/index.js!./main.css");
