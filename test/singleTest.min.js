...
/***/ function(module, exports, __webpack_require__) {
	...
	var _singleTestController = __webpack_require__(3);

	var _singleTestService = __webpack_require__(4);
	...
	var SinglePage = function (_JSpringComponent) {
		_inherits(SinglePage, _JSpringComponent);

		function SinglePage() {
			_classCallCheck(this, SinglePage);

			var selector = '#for_inst';
			return _possibleConstructorReturn(this, (SinglePage.__proto__ || Object.getPrototypeOf(SinglePage)).call(this, _singleTestController.controller, _singleTestService.service, selector));
		}
	  ...
	  **/
	   ...
	   */
		...
		function setMapObjValue(scope, keyStr, value) {
			...
			keyArr.reduce(function reduceFn(a, b) {}, scope);
		};
		...
		function genComponent(vObj, attrStr, inst, parent, index) {
			...
			if (component) {
				...
				if (vNodeTemplate) {
					...
					component.$scope = optimizeCb(defineProp, component, component.data, {}, inst);
					_.push(vObj.children, component.vObj);
				}
				return component.vTpl = '(function(' + component.key + ', ' + (component.index || '$index') + ', ' + (component.parent || '$parent') + ') {' + 'with(__j._cp["' + tagName + '"].$scope) {' + 'return __j._n(\"' + vObj.tagName + '\", ' + attrStr + ', [' + component.vTpl + '])' + '}' + '} (' + vObj.isComponent + ', ' + index + ', "' + parent + '"))';
			}
...
/***/ function(module, exports) {
	...
	var controller = exports.controller = function controller($scope, $, module, _this) {
...
/***/ function(module, exports) {
	...
	var service = exports.service = function service($, module) {
		return {
			obj: {
				name: 'abc'
			},
			...
			logObjName: function logObjName() {
				console.log(this.obj.name);
			},

			arr: [1, 2, 3],
			dataFn: function dataFn(el) {
				return {
					id: el + 'aaa',
					cityId: el + 'shanghai'
				};
