	  ...
	  */
		...
		function genFor(vObj, attrStr, inst) {
			...
			if (match = vObj.isFor.match(REGEXP.forExpRE)) {
				...
				if (!vObj.isComponent) {
					...
					str += 'return ' + genComponent(vObj, attrStr, inst, index, parent);
				}
				str += '})';
				return str;
			}
		...
		function genComponent(vObj, attrStr, inst, parent, index) {
			...
			if (component) {
				...
				return component.vTpl = '(function(' + component.data + ', ' + (component.index || '$index') + ', ' + (component.parent || '$parent') + ') {' + 'return __j._n(\"' + vObj.tagName + '\", ' + attrStr + ', [' + component.vTpl + '])' + '}(' + vObj.isComponent + ', ' + index + ', "' + parent + '"))';
			}
